      ...
      <div>
        ...
        <div className="border border-gray-200">
          ...
          {isLoading ? (
            // Skeleton Loading
            [1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="grid grid-cols-12 gap-4 px-6 py-6 border-b border-gray-200 animate-pulse">
                <div className="col-span-3"><div className="h-4 w-32 bg-gray-200 rounded"></div></div>
                <div className="col-span-3"><div className="h-4 w-40 bg-gray-200 rounded"></div></div>
                <div className="col-span-2"><div className="h-6 w-16 bg-gray-200 rounded"></div></div>
                <div className="col-span-2"><div className="h-6 w-16 bg-gray-200 rounded"></div></div>
                <div className="col-span-2 text-right"><div className="h-4 w-12 bg-gray-200 rounded inline-block"></div></div>
              </div>
            ))
            ...
            filteredUsers.map((user) => (
              ...
              >
                ...
                <div className="col-span-2 flex items-center">
                  <span
                    className={`inline-block px-3 py-1 text-xs font-medium ${user.role === 'admin'
                      ? 'bg-black text-white'
                      : user.role === 'teacher'
                ...
                <div className="col-span-2 flex items-center">
                  <span
                    className={`inline-block px-3 py-1 text-xs font-medium ${user.isActive
                      ? 'border border-black text-black'
      ...
      {(showAddModal || showEditModal) && (
        <div className="fixed inset-0 bg-white/70 backdrop-blur-sm z-50 flex items-center justify-center p-8">
          <div className="bg-white max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            {/* Modal Body */}
            <form onSubmit={showEditModal ? handleUpdate : handleSubmit} className="p-8 space-y-8">
                ...
                <div className="grid grid-cols-3 gap-1 bg-gray-200 p-1">
                  {['student', 'teacher', 'admin'].map((role) => (
                    <button
                      ...
                      className={`px-6 py-4 transition-colors text-sm font-medium ${formData.role === role ? 'bg-black text-white' : 'bg-white text-black hover:bg-gray-50'
                        }`}
                    >
