...
import { departmentsApi, Department, CreateDepartmentData } from '@/lib/api/departments';
      ...
      <div className="border-b border-gray-200 pb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-gray-600">Manage academic departments and faculties</p>
          </div>
          <button
        ...
        <div className="grid md:grid-cols-2 gap-1 bg-gray-200 p-1">
          {isLoading ? (
            ...
            filteredDepartments.map((dept) => (
              <div key={dept.id} className="bg-white p-8 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="text-2xl font-bold text-black">{dept.code}</div>
                      <span
                        className={`px-3 py-1 text-xs font-medium ${dept.isActive
                    ...
                    <div className="text-lg font-medium text-black mb-1">{dept.name}</div>
                ...
                <div className="space-y-3 text-sm mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-black font-medium">{dept.headOfDepartment}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-1 bg-gray-100 p-1">
                  <div className="bg-white p-4">
                    ...
                    <div className="text-xl font-bold text-black">{(dept as any)._count?.courses || 0}</div>
                  </div>
                  <div className="bg-white p-4">
                    <div className="text-xs text-gray-400 uppercase tracking-wide mb-1">
                      Sections
                    </div>
                    <div className="text-xl font-bold text-black">{(dept as any)._count?.sections || 0}</div>
                  </div>
                </div>
              </div>
            ))
