...
export default function EventsManagementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.startDate || !formData.endDate || !formData.eventType) {
    ...
    <div className="space-y-12">
      ...
      <div className="border-b border-gray-200 pb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-4xl font-bold text-black mb-2">Events & Holidays</h1>
            <p className="text-gray-600">Manage academic calendar and special events</p>
          </div>
          <button
            onClick={() => {
              setEditingId(null);
        ...
        <div className="border border-gray-200">
          {isLoading ? (
            ...
            filteredEvents.map((event, index) => (
              <div
                key={event.id}
                className={`p-6 hover:bg-gray-50 transition-colors ${index !== filteredEvents.length - 1 ? 'border-b border-gray-200' : ''
                  }`}
              >
          ...
          <div className="bg-white max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-8 py-6 border-b border-gray-200">
              <div>
                ...
                <h2 className="text-2xl font-bold text-black">{editingId ? 'Edit Event' : 'Add New Event'}</h2>
              </div>
              <button
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <label htmlFor="isAllDay" className="text-sm font-medium text-black">
                      All day event
                    </label>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="h-5 w-5 border-gray-300 text-black focus:ring-black"
                    />
                    <label htmlFor="affectsSchedule" className="text-sm font-medium text-black">
